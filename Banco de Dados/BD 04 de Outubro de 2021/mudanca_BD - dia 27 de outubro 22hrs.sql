...
INSERT INTO `area_atuacao` VALUES (2,1),(1,2),(3,4);
/*!40000 ALTER TABLE `area_atuacao` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `area_atuacao_has_motorista`
--

DROP TABLE IF EXISTS `area_atuacao_has_motorista`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `area_atuacao_has_motorista` (
  `area_atuacao_id_area_atuacao` int(11) NOT NULL,
  `motorista_id_motorista` int(11) NOT NULL,
  PRIMARY KEY (`area_atuacao_id_area_atuacao`,`motorista_id_motorista`),
  KEY `fk_area_atuacao_has_motorista_motorista1_idx` (`motorista_id_motorista`),
  KEY `fk_area_atuacao_has_motorista_area_atuacao1_idx` (`area_atuacao_id_area_atuacao`),
  CONSTRAINT `fk_area_atuacao_has_motorista_area_atuacao1` FOREIGN KEY (`area_atuacao_id_area_atuacao`) REFERENCES `area_atuacao` (`id_area_atuacao`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_area_atuacao_has_motorista_motorista1` FOREIGN KEY (`motorista_id_motorista`) REFERENCES `motorista` (`id_motorista`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `area_atuacao_has_motorista`
--

LOCK TABLES `area_atuacao_has_motorista` WRITE;
/*!40000 ALTER TABLE `area_atuacao_has_motorista` DISABLE KEYS */;
/*!40000 ALTER TABLE `area_atuacao_has_motorista` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `avaliacao` (
  ...
  `cliente_avaliacao` int(11) NOT NULL,
  `motorista_avaliacao` int(11) NOT NULL,
  `proposta_avaliacao` int(11) NOT NULL,
...
INSERT INTO `cidade` VALUES (1,'Porto UniÃ£o',3),(2,'UniÃ£o da VitÃ³ria',2),(4,'Porto VitÃ³ria',2),(5,'Belo Horizonte',6),(6,'Ouro Preto',6);
...
INSERT INTO `cliente` VALUES (1,'teste','123','teste@teste','2e6f9b0d5885b6010f9167787445617f553a735f','123',1),(5,'oi','1234','oi@oi','ef67e0868c98e5f0b0e2fcd9b0c4a3bad808f551','1234',NULL),(6,'Jennifer','125.985.008-00','jenny@gmail.com','c6080a4c5ab5d831ad3dc3d39cd0f5ad27c25bbd','42 99925-3227',NULL),(7,'1','1','1@1','356a192b7913b04c54574d18c28d46e6395428ab','1',NULL);
...
INSERT INTO `estado` VALUES (1,'SÃ£o Paulo'),(2,'ParanÃ¡'),(3,'Santa Catarina'),(4,'Rio de Janeiro'),(5,'Rio Grande do Sul'),(6,'Minas Gerais');
...
INSERT INTO `motorista` VALUES (1,'mot','543543543','mot@mot','984ac749fe8b492e8407bb6fa3d0d8f6eb153baf','543543543','fhgfhjdffsdgfghjf',NULL);
...
CREATE TABLE `resposta` (
  ...
  `cliente_resposta` int(11) NOT NULL,
  `motorista_resposta` int(11) NOT NULL,
  `avaliacao_resposta` int(11) NOT NULL,
...
-- Dump completed on 2021-10-27 22:13:01
