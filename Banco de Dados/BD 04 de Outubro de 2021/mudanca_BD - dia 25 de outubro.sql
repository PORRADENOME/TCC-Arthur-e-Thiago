...
INSERT INTO `cidade` VALUES (1,'Porto UniÃ£o',3),(2,'UniÃ£o da VitÃ³ria',2),(4,'Porto VitÃ³ria',2);
...
INSERT INTO `endereco` VALUES (1,'','BRASIL',2,1,'bairro','rua',1,NULL,1);
...
INSERT INTO `estado` VALUES (1,'SÃ£o Paulo'),(2,'ParanÃ¡'),(3,'Santa Catarina'),(4,'Rio de Janeiro'),(5,'Rio Grande do Sul');
...
CREATE TABLE `proposta` (
  ...
  `proposta_aprovada` tinyint(4) DEFAULT NULL,
  `informacoes_adicionais` varchar(200) DEFAULT NULL,
  `elaborando` int(11) NOT NULL,
...
CREATE TABLE `veículo` (
  ...
  `motorista_veiculo` int(11) DEFAULT NULL,
...
-- Dump completed on 2021-10-25 14:04:12
