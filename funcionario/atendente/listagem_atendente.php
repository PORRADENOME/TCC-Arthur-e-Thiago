...
<div class="container">
    <div class="row">
        <div class="col-12">
            <h1>Listagem - atendente</h1>
            <a href="cadastro_atendente.php" class="btn btn-success">Cadastrar</a>
            <table id="grid-data" class="table table-condensed table-hover table striped">
                <thead>
                <tr>
                    <th data-column-id="id">ID</th>
                    <th data-column-id="nome" data-order="desc" data-sortable="true">Nome</th>
                    <th data-column-id="funcao" data-sortable="true">funcao</th>
    ...
    $(document). ready(function () {
        grid=$("#grid-data").bootgrid({
            ...
            grid.find(".command-edit").on("click", function (e) {
                document.location='form_editar_atendente.php?id=' + $(this).data("row-id");
